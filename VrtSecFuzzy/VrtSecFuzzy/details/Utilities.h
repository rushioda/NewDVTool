...
#ifndef _VrtSecFuzzy_VrtSecFuzzy_Utilities_H
#define _VrtSecFuzzy_VrtSecFuzzy_Utilities_H
...
namespace VKalVrtAthena {
  ...
  template<class TrackT> void VrtSecFuzzy::getIntersection( TrackT *trk, vector<IntersectionPos*>& layers, const Trk::Perigee* per) {
    //
  ...
  //____________________________________________________________________________________________________
  template<class TrackT> void VrtSecFuzzy::setIntersection( TrackT* trk, IntersectionPos *layer, const Trk::Perigee* per) {
  ...
  //____________________________________________________________________________________________________
  template<class LeptonFlavor>
  StatusCode VrtSecFuzzy::augmentDVimpactParametersToLeptons( const std::string& containerName )
  {
    
    const xAOD::VertexContainer *secondaryVertexContainer( nullptr );
    ATH_CHECK( evtStore()->retrieve( secondaryVertexContainer, "VrtSecFuzzy_" + m_jp.secondaryVerticesContainerName ) );
