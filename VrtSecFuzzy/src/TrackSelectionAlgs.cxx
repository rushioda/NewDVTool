...
#include "VrtSecFuzzy/NtupleVars.h"
...
namespace VKalVrtAthena {
  ...
  bool VrtSecFuzzy::selectTrack_d0Cut       ( const xAOD::TrackParticle* trk ) const { return ( fabs( trk->d0() ) > m_jp.d0TrkPVDstMinCut && fabs( trk->d0() ) < m_jp.d0TrkPVDstMaxCut ); }
  bool VrtSecFuzzy::selectTrack_z0Cut       ( const xAOD::TrackParticle* trk ) const { return ( fabs( trk->z0() ) > m_jp.z0TrkPVDstMinCut && fabs( trk->z0() ) < m_jp.z0TrkPVDstMaxCut ); }
  bool VrtSecFuzzy::selectTrack_d0errCut    ( const xAOD::TrackParticle* trk ) const { const double cov11 = trk->definingParametersCovMatrix()(0,0); return cov11 < m_jp.d0TrkErrorCut*m_jp.d0TrkErrorCut; }
  bool VrtSecFuzzy::selectTrack_z0errCut    ( const xAOD::TrackParticle* trk ) const { const double cov22 = trk->definingParametersCovMatrix()(1,1); return cov22 < m_jp.z0TrkErrorCut*m_jp.z0TrkErrorCut; }
  bool VrtSecFuzzy::selectTrack_d0signifCut ( const xAOD::TrackParticle*     ) const { return true; }
  bool VrtSecFuzzy::selectTrack_z0signifCut ( const xAOD::TrackParticle*     ) const { return true; }
  ...
  //____________________________________________________________________________________________________
  bool VrtSecFuzzy::selectTrack_hitPattern( const xAOD::TrackParticle* trk ) const {
  ...
  //____________________________________________________________________________________________________
  bool VrtSecFuzzy::selectTrack_hitPatternTight( const xAOD::TrackParticle* trk ) const {
    uint8_t PixelHits = 0;
    uint8_t SCTHits   = 0; 
    uint8_t TRTHits   = 0;
  ...
  //____________________________________________________________________________________________________
  void VrtSecFuzzy::selectTrack( const xAOD::TrackParticle* trk ) {
...
//      if( m_jp.do_d0errCut )    m_trackSelectionFuncs.emplace_back( &VrtSecFuzzy::selectTrack_d0errCut );
//      if( m_jp.do_z0errCut )    m_trackSelectionFuncs.emplace_back( &VrtSecFuzzy::selectTrack_z0errCut );
      //if( m_jp.do_d0signifCut ) m_trackSelectionFuncs.emplace_back( &VrtSecFuzzy::selectTrack_d0signifCut ); // not implemented yet
      //if( m_jp.do_z0signifCut ) m_trackSelectionFuncs.emplace_back( &VrtSecFuzzy::selectTrack_z0signifCut ); // not implemented yet
      
      // These cuts are used by default
//      m_trackSelectionFuncs.emplace_back( &VrtSecFuzzy::selectTrack_hitPattern );
//      m_trackSelectionFuncs.emplace_back( &VrtSecFuzzy::selectTrack_hitPatternTight );
//      m_trackSelectionFuncs.emplace_back( &VrtSecFuzzy::selectTrack_chi2Cut );
//      m_trackSelectionFuncs.emplace_back( &VrtSecFuzzy::selectTrack_pTCut );
  ...
  //____________________________________________________________________________________________________
  StatusCode  VrtSecFuzzy::selectTracksInDet() { 
  ...
  //____________________________________________________________________________________________________
  StatusCode  VrtSecFuzzy::selectTracksFromMuons() { 
  ...
  //____________________________________________________________________________________________________
  StatusCode  VrtSecFuzzy::selectTracksFromElectrons() { 
