...
//-------------- BDT cut, Ushioda, 2021/4/15
        float eta_i = (*itrk)->eta();
        float eta_j = (*jtrk)->eta();
        float dEta = fabs(eta_i - eta_j);
        float dPhi1 = fabs((*itrk)->phi() - (*jtrk)->phi());
        float dPhi2 = fabs(2.0*M_PI - dPhi1);
...
//          vertex->auxdata<float>("BDT")    = wgtSelect;
  ...
  //____________________________________________________________________________________________________
  StatusCode VrtSecFuzzy::rearrangeTracks( std::vector<WrkVrt> *workVerticesContainer )
  {
  ...
  //____________________________________________________________________________________________________
  StatusCode VrtSecFuzzy::reassembleVertices( std::vector<WrkVrt>* workVerticesContainer )
  {
  ...
  //____________________________________________________________________________________________________
  StatusCode VrtSecFuzzy::associateNonSelectedTracks( std::vector<WrkVrt>* workVerticesContainer )
  {
  ...
  //____________________________________________________________________________________________________
  StatusCode VrtSecFuzzy::mergeByShuffling( std::vector<WrkVrt> *workVerticesContainer )
  {
  ...
  //____________________________________________________________________________________________________
  StatusCode VrtSecFuzzy::mergeFinalVertices( std::vector<WrkVrt> *workVerticesContainer )
  {
    ...
    while (true) {
      ...
      std::pair<unsigned, unsigned> indexPair { AlgConsts::invalidUnsigned, AlgConsts::invalidUnsigned };
      auto minDistance = findMinVerticesPair( workVerticesContainer, indexPair, &VrtSecFuzzy::distanceBetweenVertices );
  ...
  //____________________________________________________________________________________________________
  StatusCode VrtSecFuzzy::refitAndSelectGoodQualityVertices( std::vector<WrkVrt> *workVerticesContainer )
  {
    ...
    ATH_CHECK( evtStore()->retrieve( secondaryVertexContainer, "VrtSecFuzzy_" + m_jp.secondaryVerticesContainerName + m_jp.augVerString ) );
  ...
  //____________________________________________________________________________________________________
  StatusCode VrtSecFuzzy::monitorVertexingAlgorithmStep( std::vector<WrkVrt>* workVerticesContainer, const std::string name, bool final ) {
    ...
    if( m_jp.FillIntermediateVertices ) {
      ...
      ATH_CHECK( evtStore()->retrieve( intermediateVertexContainer, "VrtSecFuzzy_IntermediateVertices_" + name + m_jp.augVerString ) );
