...
#include "VrtSecFuzzy/IntersectionPos.h"
...
namespace VKalVrtAthena {
  ...
  //____________________________________________________________________________________________________
  double VrtSecFuzzy::significanceBetweenVertices( const WrkVrt& v1, const WrkVrt& v2 ) const {
    try {
  ...
  //____________________________________________________________________________________________________
  double VrtSecFuzzy::distanceBetweenVertices( const WrkVrt& v1, const WrkVrt& v2 ) const {
    return (v2.vertex - v1.vertex).norm();
  }
  
  
  //____________________________________________________________________________________________________
  StatusCode VrtSecFuzzy::disassembleVertex(std::vector<WrkVrt> *workVerticesContainer, const unsigned& iv )
  {
  ...
  //____________________________________________________________________________________________________
  double  VrtSecFuzzy::improveVertexChi2( WrkVrt& vertex )
  {
    //
  ...
  //____________________________________________________________________________________________________
  void VrtSecFuzzy::removeTrackFromVertex(std::vector<WrkVrt> *workVerticesContainer, 
  ...
  //____________________________________________________________________________________________________
  double VrtSecFuzzy::findMinVerticesPair( std::vector<WrkVrt> *workVerticesContainer, std::pair<unsigned, unsigned>& indexPair, VrtSecFuzzy::AlgForVerticesPair algorithm )
  {  
    //
  ...
  //____________________________________________________________________________________________________
  double VrtSecFuzzy::findMinVerticesNextPair( std::vector<WrkVrt> *workVerticesContainer, std::pair<unsigned, unsigned>& indexPair )
  {  
    //   
  ...
  //____________________________________________________________________________________________________
  StatusCode VrtSecFuzzy::mergeVertices( WrkVrt& v1, WrkVrt& v2 )
  {
    //
  ...
  //____________________________________________________________________________________________________
  StatusCode VrtSecFuzzy::refitVertex( WrkVrt& workVertex )
  {
  ...
  //____________________________________________________________________________________________________
  StatusCode VrtSecFuzzy::refitVertexWithSuggestion( WrkVrt& workVertex, const Amg::Vector3D& suggestedPosition )
  {
  ...
  //____________________________________________________________________________________________________
  size_t VrtSecFuzzy::nTrkCommon( std::vector<WrkVrt> *workVerticesContainer, const std::pair<unsigned, unsigned>& pairIndex) const
  {
    //
  ...
  //____________________________________________________________________________________________________
  void VrtSecFuzzy::trackClassification(std::vector<WrkVrt> *workVerticesContainer, std::map<long int, std::vector<long int> >& trackToVertexMap )
  { 
  ...
  //____________________________________________________________________________________________________
  double VrtSecFuzzy::findWorstChi2ofMaximallySharedTrack(std::vector<WrkVrt> *workVerticesContainer, 
  ...
  //____________________________________________________________________________________________________
  void VrtSecFuzzy::printWrkSet(const std::vector<WrkVrt> *workVerticesContainer, const std::string name)
  {
  ...
  //____________________________________________________________________________________________________
  void VrtSecFuzzy::fillTrackSummary( track_summary& summary, const xAOD::TrackParticle *trk ) {
  ...
  //____________________________________________________________________________________________________
  void VrtSecFuzzy::removeInconsistentTracks( WrkVrt& wrkvrt )
  {
  ...
  //____________________________________________________________________________________________________
  void VrtSecFuzzy::dumpTruthInformation() {
