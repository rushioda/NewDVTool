...
namespace VKalVrtAthena {
  ...
  const xAOD::TruthParticle*  VrtSecFuzzy::getTrkGenParticle ( const xAOD::TrackParticle *trkPart ) const 
  {
  ...
  //____________________________________________________________________________________________________
  StatusCode VrtSecFuzzy::categorizeVertexTruthTopology(  xAOD::Vertex *vertex )
  {
